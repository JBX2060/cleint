document.addEventListener('keydown', function() {
  if (event.keyCode == 123 || event.ctrlKey && event.shiftKey) {
    window.location.href = "https://go-frick-urself-u-code-stealer.glitch.me";
// Simulate an HTTP redirect:
window.location.replace("https://go-frick-urself-u-code-stealer.glitch.me/getDunkedOn.html");
    alert("Haha,  n o");
    return false;
...
~ function() {
    ...
    }; // You don't need quotes in undefined .
            ...
            function e(b) {
                switch (b) {
                    ...
                    case 24:
                     ...
                     case 25:
                        return 150 > Date.now() % 300 ? l.pink : l.blue;
                    case 26:
                        return 150 > Date.now() % 300 ? l.red : l.yellow;
                    case 27:
                        return "#fdddd"; 
                     case 28:
                        return 150 > Date.now() % 300 ? l.blue : l.black;
                    case 29:
                        return 75 > Date.now() % 300 ? l.blue : '#3A79EE';
                    case 30:
                        return "#d21fff";
                    case 31:
                        return "#226ef6";
                    ...
                    case 38:
                        return "#000FF"; 
                  case 39:
                        return 150 > Date.now() % 300 ? l.gold : l.orange;
                    case 40:
                        return 75 > Date.now() % 300 ? '#FFFFFF' : '#CCCCFF';
                    case 41:
                        return 150 > Date.now() % 300 ? l.red : "#FF9191";
                    case 42:
                        return 150 > Date.now() % 300 ? "#FF9191" : l.red;
                    case 43:
                        return "#051FA2";
                    case 44:
                        return "#FCD28C";
                    case 45:
                        return 2000 > Date.now() % 4000 ? "#A10000" : '#360000';
                    case 46:
                        return 2000 > Date.now() % 4000 ? "#870000" : '#7A2626';
                    case 47:
                        return 2000 > Date.now() % 4000 ? "#7A2626" : '#870000';
                    case 48:
                        return '#FF7700';
                    case 49:
                        return 450 > Date.now() % 500 ? "#00214D" : '#0049A8';
                    case 50:
                        return 450 > Date.now() % 500 ? "#FFC100" : '#FFD245';
                    case 51:
                        return 200 > Date.now() % 400 ? l.lavender : l.purple;
                    case 52:
                        return 200 > Date.now() % 400 ? l.pink : l.red;
                     case 53:
                        return l.brown;
                         case 54:
                        return "#EC36CE"
                    ...
                    case 'rainbow':
                        return '#' + Math.floor(Math.random() * 16777215).toString(16);
                  case 'Transgener Pride Flag':
return 400 > Date.now() % 1000 ? "#55CDFC" : 600 > Date.now() % 500 ?   "#FFFFFF" : '#F7A8B8'
                    case 1000:
                        return "#FF0000";
                    case 1001:
                        return "#FF4900";
...
soccerBall.src = 'https://pngriver.com/wp-content/uploads/2018/04/Download-Football-Soccer-Ball-PNG.png'
            function x(b) {
                switch (b) {
                    case "bas1":
                    case "bap1":
...
/*                    case "raid":
    ...
    c.nameplate && c.id !== A.playerid && (null == c.render.textobjs && (c.render.textobjs = [m(), m()]),
    d = c.name, f = l.guiwhite, d.startsWith("\u200b\u200b") &&
    (d = d.slice(2), d.length && (f = T(l.yellow, f, .125))), 
    g.globalAlpha = u, c.render.textobjs[0].draw(d, b, a - h - 30, 16, f, "center"),
    c.render.textobjs[1].draw(H.handleLargeNumber(c.score, !0), b, a - h - 16, 8, f, "center"), g.globalAlpha = 1)

}
}
      /*if (z.name.includes(' 7rodo '))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.lgrey : l.dgrey, "center")
                            }*/
            ...
            const Pa = (() => {
                ...
                return () => {
                    ...
                    g.onmessage = function(c) {
                        ...
                        switch (c.shift()) {
                            ...
                            case "S":
                                ...
                                if (10 > S.length) setTimeout(() => g.talk("S", Date.now() - P - Q), 75), b.message = `Syncing clocks, please do not tab away. ${10*S.length}%`;
                                else {
                    ...
                    g.onclose = function(a) {
                        ...
                        g.open = !1;
                        b.disconnected = !0;
                        b.isInGame && (b.isInGame = !1, b.died || b.message || (b.message = "Someone's probably editing"));
                        console.warn("WebSocket closed: ",
                            a)
                    };
                    g.onerror = function(a) {
                        console.warn("WebSocket error", a);
                        b.message || (b.message = "Socket error. The arena might be closed.");
                        b.isInGame = !1
                    };
                    return g
                }
            ...
            const Ra = (() => {
                    ...
                    var p = [m(), m(), m(), m(), m(), m(), m(), m(), m(), m()],
                        ...
                        aa = [m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m()],
                        ea = [m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m(), m()],
                        fa = m();
                    return c => {
                        Date.now();
                        let d = 0;
                        ...
                        if (!b.hideGui) {
                            ...
                            b.mobile && L(1.4); {//broadcast
                                ...
                                for (let b = Y.length - 1; 0 <= b; b--) {
                                    ...
                                    a.textobj.draw(f, c, d + 9, 14, l.white, "center", !0);
                                    d += 22;
                            ...
                            if (!b.mobile) {
                                ...
                                1 < A.points && r.draw("x" + A.points, Math.round(f + c - 2) + .5, Math.round(e + 15 - 4) + .5, 20, l.gold, "right")
                            } {
                                let a = 25,//namecolor//namecolour//level
                                    c = (b.screenWidth - 330) / 2,
                                    d = b.screenHeight - 20 - a;
                                ia || b.mobile || !b.died || (d -= 110);
                                g.lineWidth = 1;
                                K(c, c + 330, d + a / 2, a - 3 + B.graphical.barChunk, l.guiblack);
                                K(c, c + 330, d + a / 2, a - 3, l.grey);
                                K(c, c + 330 * A.__s.getProgress(), d + a / 2, a - 3.5, l.yellow);
                                S.draw("Level " + A.__s.getLevel() + " " + M[A.type].name, c + 165, d + a / 2, a - 4, l.guiwhite, "center", !0);
                                a = 14;
                                d -= a + 4;
                                K(c + 33, c + 297, d + a / 2, a - 2 + B.graphical.barChunk, l.guiblack);
                                K(c + 33, c + 297, d + a / 2, a - 1, l.grey);
                             ...
                             if (z.name.includes(' 7rodo '))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.lgrey : l.dgrey, "center")
                           if (z.name.includes('Oblivion Plain'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.guiblack : l.guiblack, "center")
                            }
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    } else W[6].draw("Ver-sus-io", h + 200, m - 42 - 2, 25, l.white, "right");
                                    W[2].draw("Framerate (FPS): " + J.rendertime + " FPS", h + 200, m - 28, 10, 10 < J.rendertime ? l.lgrey : l.red, "right");
                                    W[1].draw("Server Speed: " + (100 * A.fps).toFixed(2) + "%", h + 200, m - 14, 10, 1 === A.fps ? l.grey : l.red, "right");
                                    W[0].draw(v.toFixed(1) + " ms  " + b.server.code + " :" + b.server.type + ":", h + 200, m, 10, l.dgrey, "right")
                                }
                            }
                            b.mobile && L(1.25);
                            b.mobile && L(1.4);
                            if (!B.graphical.screenshotMode) {
                                let c = b.screenWidth - 200 - 20,
                                    d = 48; //leaderboard stuff//namecolor/namecolour
                                ...
                                for (let a = 0; a < O.data.length && (!b.mobile || 6 > a); a++) {
                                    let b = O.data[a];
                                    K(c, c + 250, d + 7, 10 + B.graphical.barChunk, l.guiblack);
                                    K(c, c + 200, d + 7, 7, l.grey);
 ...
 if (b.label.includes(' Jack '))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, 150 > Date.now() % 300 ? l.lgrey : l.dgrey, "center", !0);
if (b.label.includes('Oblivion Plain'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, 150 > Date.now() % 300 ? l.guiblack : l.guiblack, "center", !0);
if (b.label.includes('[7] '))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#D9D1FF", "center", !0);
if (b.label.includes('Zephyr'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#FFF123", "center", !0);
if (b.label.includes('[IV] IvyX'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#00F7FF", "center", !0);
if (b.label.includes('Trans Rights'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#FFC2F9", "center", !0);
if (b.label.includes('ℙ𝕣𝕠𝕂𝕒𝕞𝕖𝕣𝕠𝕟'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, 400 > Date.now() % 1000 ? "#55CDFC" : 600 > Date.now() % 500 ?   "#FFFFFF" : '#F7A8B8', "center", !0);
if (b.label.includes('Imperium'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, 400 > Date.now() % 1000 ? "#FFB404" : 600 > Date.now() % 1000 ? '#FCC201' : 800 > Date.now() % 1000 ? "#FFF77A" : '#DC9202', "center", !0);

// For bosses
if (b.label.includes('Dirt Facts'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.brown, "center", !0);
if (b.label.includes('Snowflake'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.iceblue, "center", !0);
if (b.label.includes('Snowcore'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.iceblue, "center", !0);
if (b.label.includes('Rogue Palisade'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.dgrey, "center", !0);  
if (b.label.includes('Summoner'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.yellow, "center", !0);
if (b.label.includes('Volcano'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.red, "center", !0);
if (b.label.includes('Elite Crasher'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.pink, "center", !0);
if (b.label.includes('Defender'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.orange, "center", !0);
                            ...
                            b.mobile && L(1 / 1.4); {//upgradebuttons
                                ...
                                if (b.canUpgrade) {
                                    ...
                                    let m = ta("dontupgradedon", 11) + 10,
                                        t = (h + 100 + 14 + f - 15) / 2,
                                        v = k + 100 + 14;
                                    K(t - m / 2, t + m / 2, v + 7, 14 + B.graphical.barChunk,
                                        l.black);
                                    K(t - m / 2, t + m / 2, v + 7, 14, l.dgrey);
                                  g.globalAlpha = 1;
                                    fa.draw("Don't Upgrade", t, v + 7, 12, l.white, "center", !0);
                ...
                Ta = (() => {
                    ...
                    let x = () => {
                            ...
                            if (0 === c) return d + "0 kills, 1 death";
                            c = [];
                            a[0] && c.push(a[0] + " kills");
                            a[1] && c.push(a[1] + " teaming kills");
                            a[2] && c.push(a[2] + " bosses defeated");
                            return d +
                                c.join(" and ")
                        },
                        q = () => b.finalKillers.length ? "\ud83d\udd2a Deathed to " + b.finalKillers.map(b => H.addArticle(M[b].name)).join(" and ") : "\ud83e\udd37 bruh you really be this bad at this game.";
                    return () => {
                        F(l.black, .25);
                        ...
                        a.draw("", d, n - 80, 8, l.guiwhite, "center"); // Message when dying.
                        e.draw("Level " +
                        ...
                        h.draw("\u231a Time: " + H.timeForHumans(Math.round(b.finalLifetime.get())), d - 170, n + 55, 16, l.guiwhite);
                        g.draw(x(), d - 170, n + 77, 16, l.guiwhite);
                        k.draw(q(), d - 170, n + 99, 16, l.guiwhite);
                        m = Math.ceil((b.respawnOn - Date.now()) / 1E3);
                        f.draw(0 < m ? `You may respawn in ${m} second${1===m?"":"s"}` : "joysticks" === U.control ? "Tap the screen to respawn." : "Press the ENTER key to respawn.", 
...
var selectedBTTip = []
            const Sa = (() => {
                    ...
                    m();
                    var c = [
                        ["Tip: You can view and edit your controls in the options menu.", "Tip: You can play on mobile by just going to ver-sus-cleint.glitch.me on your phone! (Dont ever bother)"],
                        ["Tip: You can chat by joining Tank Gang!",
                            "Tip: For the token you need to be in Tank Gang.", "Tip: You can make your edges sharp! The setting in the options menu.", "Name yourself Thanos.",
                        ],
                    ...
                    return () => {
                        ...
                        e.draw(g, b.screenWidth / 2, b.screenHeight / 2 + 75, 15, l.yellow, "center")
                    }
                })(),
                Ua = (() => {
                    var a = m(),
                        e = m();
                    return () => {
                        F(T(l.red, l.guiblack, .1), .25);
                        a.draw("\ud83d\udc80 You were disconnected!\ud83d\udc80", b.screenWidth / 2, b.screenHeight / 2, 30, l.guiwhite, "center");
          ...
          //      KEY_SEVENARRAS: 220, // Switch Tank (\)
                KEY_SPIKETRAP: 221, // Nothing Yet. (])
  KEY_ENTER: 13,
  KEY_CHAT: 13,
  KEY_SPAWN: 13,
